...
const plants = [
    {
        ...
        price: '39.99',
        like: true,
        img: require('../assets/plant1.png') as ImageSourcePropType,
        about:
...

    {
        ...
        price: '29.99',
        like: false,
        img: require('../assets/plant2.png') as ImageSourcePropType,
        about:
    ...
    },
    {
        ...
        price: '25.99',
        like: false,
        img: require('../assets/plant3.png') as ImageSourcePropType,
        about:
...

    {
        ...
        price: '25.99',
        like: true,
        img: require('../assets/plant4.png') as ImageSourcePropType,
        about:
    ...
    },
    {
        ...
        price: '50.99',
        like: true,
        img: require('../assets/plant5.png') as ImageSourcePropType,
        about:
            'Potted Plant Ravenea Plant one of the most popular and beautiful species that will produce clumpms. The storage of water often gives succulent plants a more swollen or fleshy appearance than other plants, a characteristic known as succulence.',
    },
    {
        ...
        price: '50.99',
        like: false,
        img: require('../assets/plant6.png') as ImageSourcePropType,
        about:
            'Potted Plant Ravenea Plant one of the most popular and beautiful species that will produce clumpms. The storage of water often gives succulent plants a more swollen or fleshy appearance than other plants, a characteristic known as succulence.',
    },
];
